...
export interface SsmServiceInterface {
  ...
  put(ctx: Context, key: string, value: SsmParameterInterface): Promise<SsmParameterInterface | null>;
...
export class SsmService implements SsmServiceInterface {
  ...
  public async get(ctx: Context, key: string): Promise<SsmParameterInterface | null> {
    ctx.logger.debug("SsmService.get");

    return await this.dataStore.get<SsmParameterInterface>(ctx, key);
  }

  public async put(ctx: Context, key: string, value: SsmParameterInterface): Promise<SsmParameterInterface | null> {
  ...
  public async describe(ctx: Context, key: string): Promise<SsmParameterInterface | null> {
