...
export type GetParametersTarget = Target<GetParametersRequest, GetParametersResult>;
...
export const GetParameters =
  ...
  async (ctx, req) => {
    ...
    const filtered = results.filter(item => item !== null) as SsmParameterInterface[];
    
    const Parameters = filtered.map<Parameter>((param: SsmParameterInterface) => ({
